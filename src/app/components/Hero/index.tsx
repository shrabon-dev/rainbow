  ...
  return (
    <>
      <section className="hero-section relative py-20 md:pb-10 2xl:pb-50 px-3 sm:px-0">
        <Image
          className="absolute left-20 bounce-60 top-1/4"
          src={box}
          alt="shape"
        />
            ...
            <div className="w-full">
              <div className="small-md:flex items-center justify-between">
                <div className="w-full small-md:w-1/2 2xl:w-2/3 ">
                  <motion.h1
                    ...
                    className="font-bold text-2xl sm:text-4xl lg:text-6xl xl:text-[100px] leading-tight"
                  >
                    <span className="relative">
                      We shape the future{" "}
                      <span className="bounce-r-30  absolute -right-5 -top-5">
                        <Image src={tr} alt="shape" />
                      </span>{" "}
                    </span>
                    <span className="relative block xl:inline-block">
                      of{" "}
                      <span className="text-[60px] sm:text-6xl xl:text-[100px] relative inline-block">
                        <GradientColor text="business" fontWeight="semibold" />{" "}
                        <span className="bounce-30 absolute -right-20 2xl:top-5">
                          <Image src={rckt} alt="shape" />
                        </span>
                      </span>{" "}
                    </span>
                  </motion.h1>
                  <motion.p
                    ...
                    className="text-clr-text font-normal text-sm mt-4 lg:max-w-1/2 leading-7"
                  >
              ...
              >
                ...
                <span className="flex items-center gap-3">
                  ...
                  <span className="txt">
                    <p className="font-inter text-sm text-clr-text">
                      Free Consultant
                    </p>
                    <p className="font-inter font-medium text-base text-dark">
                      (406) 555-0120
                    </p>
                  </span>
                </span>
              ...
              >
                ...
                <span className="txt">
                  <p className="font-inter text-sm text-clr-text">
                    <span className="font-bold text-g1">2.5K+</span> Business
                    Peoples <br /> Already Registered
                  </p>
                </span>
              </motion.div>
            </div>
              ...
              <div className="hr_img md:absolute -bottom-20 right-0 -z-10 md:w-[60%] xl:w-[70%] 2xl:w-[1120px] h-fit">
                <div className="text_circle absolute md:-top-12 xl:-top-20 left-[55%] -translate-x-1/2  w-fit h-fit">
                  <Image
                    src={crcl_txt}
                    alt="hero image"
                    className="md:w-24 md:h-24 xl:w-44 xl:h-44 rotate-360 border-2 border-clr-text border-dashed "
                  />
