...
export default function Button({text}: {text?: string}) {
  return (
    ...
    <button className="bg-btn text-white font-semibold text-sm cursor-pointer px-5 py-3 rounded-[10px] btn_shadow text-shadow-sm text-shadow-black/20">{text}</button>
  )
}
