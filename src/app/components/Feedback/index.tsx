...
import fdbcImgSix from "@/app/assets/images/imgFD.jpg";
import fdbcImgSeven from "@/app/assets/images/imgFD2.jpg";
import fdbcImgEight from "@/app/assets/images/imgFD3.jpg";
                    ...
                    centerSlide == index ? (
                      ...
                      >
                        <motion.div
                          ...
                          className="center clientImg relative -left-4  -top-1/2"
                        >
                      ...
                      >
                        <motion.div
                          key={index}
                          variants={itemVariant}
                          className="img w-6 md:w-10 h-6 md:h-10 rounded-full overflow-hidden border-2  border-white"
                        >
                          <Image
                            className="w-full h-full object-top block object-cover"
                            src={item.img}
              ...
              {clientFeedbacks.map((item, index) => (
                <SwiperSlide key={index}>
                  <motion.div
                    ...
                    className="info max-w-[740px] mx-auto text-center"
                  >
                    ...
                    <h6 className="font-normal text-base md:text-lg pt-8 pb-3 text-clr-text  ">
                      <span className="text-clr">{item.name}</span> -{" "}
                      {item.disg}
                    </h6>
