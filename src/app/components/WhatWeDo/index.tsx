  ...
  const serviceData = [
    {
      ...
      desc: "Where we specialize in transforming your visions into unforgettable experiences. With a passion for perfection and an eye for detail our dedicated team of event.",
      img: imgOne,
      link: "/",
    },
    {
      ...
      desc: "Expert guidance to help your business thrive. We analyze, strategize, and implement solutions tailored to your unique needs.",
      img: imgOne,
      link: "/",
    },
    {
      ...
      desc: "Comprehensive financial planning and advisory services to secure your financial future and optimize your investments.",
      img: imgOne,
      link: "/",
    },
    {
      ...
      desc: "Innovative marketing strategies to boost your brand visibility, engage your audience, and drive significant growth.",
      img: imgOne,
      link: "/",
    },
    {
      ...
      desc: "Optimizing your workforce with effective talent acquisition, development, and retention strategies.",
      img: imgOne,
      link: "/",
    },
    {
      ...
      desc: "Guiding your business through the complexities of digital change to enhance efficiency and competitiveness.",
      img: imgOne,
      link: "/",
    },
  ];
        ...
        <div className="container mx-auto py-20">
          <div className="title text-center">
            ...
            <motion.h2
              ...
              viewport={{ once: true, amount: 0.4 }}
              className=" text-clr text-5xl font-semibold mt-10"
            >
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.4 }}
            className="services_box relative z-10 md:mt-20 h-[600px]"
          >
            ...
            >
              <div className=" inline-flex items-center pt-[850px] sm:pt-[950px] md:pt-[600px] justify-center mx-auto">
                ...
                <span className="slide_btn w-40 mx-auto z-[999] relative md:-top-38  lg:-top-36  md:-right-68 lg:-right-90 inline-flex items-center">
                  <button
                    onClick={handlePrev}
                    className="rotate-90  next cursor-pointer duration-300 ease-linear transition-all hover:from-g2 hover:to-g1 left-0  w-10 h-10 border-2 border-primary/20  inline-flex items-center justify-center bg-gradient-to-br hover:border-white from-g2/0 to-g1/0 rounded-full group"
                  >
                    <Image
                  ...
                  <button
                    onClick={handleNext}
                    className=" ml-3 rotate-90 prev right-0 z-[11] cursor-pointer duration-300 ease-linear transition-all hover:from-g2 hover:to-g1    w-10 h-10 border-2 border-primary/20  inline-flex items-center justify-center bg-gradient-to-br hover:border-white from-g2/0 to-g1/0 rounded-full group"
                  >
                    <Image
